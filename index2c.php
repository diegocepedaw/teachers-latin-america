                    ...
                    <div id="main-slider" class="liquid-slider " >
                        <?php
                         if(isset($_POST['teaching_area_id']) && isset($_POST['grade_level_id'])){
                            ...
                            {
                                 echo "<img src='images/".  $array['teaching_area_id'] .".png'height='42' width='42'>";
                            }
                            echo' <p>Email: '. $row["email"]. '</p>'.  '<p>Citizenship: '. $row["citizenship"]. '</p>'.  '<p>Years of experience teaching: '. $row["years_of_experience_teaching"]. '</p><p>Higher educaion : '. $row["field_of_study"] . ' at '. $row["university_college_name"]. '</p>Teaching certifications: '.$row["teaching_certification"]  .'</p></div>';
